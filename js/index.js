...
let mainLoader = document.querySelector("#loading");
...
function clearData() {
  ...
  document.querySelector("#searchedMeals").innerHTML = "";
  document.querySelector("#mealCategories").innerHTML = "";
  document.querySelector("#mealArea").innerHTML = "";
  document.querySelector("#mealIngredient").innerHTML = "";

  mainLoader.classList.remove("d-none");
  categoriesLoader.classList.remove("d-none");
  areaLoader.classList.remove("d-none");
  ingredientLoader.classList.remove("d-none");
...
function displayIngredient() {
  let cartona = "";
  for (let i = 0; i < 30; i++) {
    if (listIngredient[i]["strDescription"]) {
      cartona += `
          <div class="col-md-3">
...
async function getMealDetails(mealName) {
  document.querySelector("#details .container").classList.add("d-none");
